/** Requisitos de viagem — versão Node */

const REQUIREMENTS = require('./travelRequirements.json');
...
function getTravelRequirements(country) {
...
module.exports = { getTravelRequirements, REQUIREMENTS };
