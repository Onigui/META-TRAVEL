...
import { getAirportName } from './placeMeta.js';

export const AIRLINE_FARES = {
  gol: [
    {
      brand: 'Light',
      mult: 0.88,
      cabin: 'Econômica',
      baggage: { carryOnKg: 10, checkedBags: 0, checkedWeightKg: 0, extraCheckedBagPrice: 320, extraBagWeightKg: 23 },
    ...
    },
    {
      ...
      mult: 1.0,
      cabin: 'Econômica',
      baggage: { carryOnKg: 12, checkedBags: 1, checkedWeightKg: 23, extraCheckedBagPrice: 280, extraBagWeightKg: 23 },
    ...
    },
    {
      ...
      mult: 1.18,
      cabin: 'Econômica',
      baggage: { carryOnKg: 12, checkedBags: 2, checkedWeightKg: 23, extraCheckedBagPrice: 250, extraBagWeightKg: 23 },
  ...
  latam: [
    {
      ...
      mult: 0.9,
      cabin: 'Econômica',
      baggage: { carryOnKg: 10, checkedBags: 0, checkedWeightKg: 0, extraCheckedBagPrice: 350, extraBagWeightKg: 23 },
      included: ['Item pessoal', 'Bagagem de mão até 10 kg'],
    ...
    },
    {
      ...
      mult: 1.0,
      cabin: 'Econômica',
      baggage: { carryOnKg: 12, checkedBags: 1, checkedWeightKg: 23, extraCheckedBagPrice: 300, extraBagWeightKg: 23 },
    ...
    },
    {
      ...
      baggage: { carryOnKg: 16, checkedBags: 2, checkedWeightKg: 23, extraCheckedBagPrice: 280, extraBagWeightKg: 23 },
  ...
  azul: [
    {
      ...
      mult: 0.95,
      cabin: 'Econômica',
      baggage: { carryOnKg: 10, checkedBags: 0, checkedWeightKg: 0, extraCheckedBagPrice: 300, extraBagWeightKg: 23 },
    ...
    },
    {
      ...
      mult: 1.08,
      cabin: 'Econômica',
      baggage: { carryOnKg: 10, checkedBags: 1, checkedWeightKg: 23, extraCheckedBagPrice: 270, extraBagWeightKg: 23 },
  ...
  default: [
    {
      ...
      mult: 0.92,
      cabin: 'Econômica',
      baggage: { carryOnKg: 8, checkedBags: 0, checkedWeightKg: 0, extraCheckedBagPrice: 450, extraBagWeightKg: 23 },
    ...
    },
    {
      ...
      mult: 1.0,
      cabin: 'Econômica',
      baggage: { carryOnKg: 10, checkedBags: 1, checkedWeightKg: 23, extraCheckedBagPrice: 400, extraBagWeightKg: 23 },
      included: ['Item pessoal', 'Bagagem de mão 10 kg', '1 bagagem despachada 23 kg'],
    ...
    },
    {
      ...
      mult: 1.15,
      cabin: 'Econômica',
      baggage: { carryOnKg: 12, checkedBags: 2, checkedWeightKg: 23, extraCheckedBagPrice: 380, extraBagWeightKg: 23 },
...
export const CARRIER_CODES = { gol: 'G3', latam: 'LA', azul: 'AD', tap: 'TP', american: 'AA', emirates: 'EK', qatar: 'QR', avianca: 'AV' };

export function pickLayoverAirports(origin, destination, stops) {
  if (!stops) return [];
...
export function buildRouteSegments(origin, destination, layoverCodes, durationMins, carrierCode = 'G3') {
  ...
  for (let i = 0; i < legCount; i++) {
    ...
    segments.push({
      ...
      flightNumber: `${carrierCode} ${1000 + i * 111}`,
    });
  }
  return segments;
}

export function buildLayovers(layoverCodes) {
...
export function getBookingUrl(airlineId, origin, destination, date) {
...
export function enrichFlightDetails(flight) {
  const d = flight.details || {};
  if (d.segments?.length && d.layovers) return flight;

  const stops = d.stops || 0;
  const layoverCodes = pickLayoverAirports(
    { airport: d.origin, country: d.originCountry || '' },
    { airport: d.destination, country: d.destinationCountry || '' },
    stops
  );
    ...
    details: {
      ...
      segments:
        ...
        buildRouteSegments(
          ...
          CARRIER_CODES[flight.provider] || 'XX'
        ),
    },
  };
}
